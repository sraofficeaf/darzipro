            ...
            return ListView(
              ...
              children: [
                ...
                _DashHeroCard(
                  ...
                  inProgressCount: orders.where((o) => o.status != OrderStatus.delivered && o.status != OrderStatus.cancelled).length,
                  overdueCount: overdueOrdersCount,
                  onOpenReports: () {
                    ref.read(navSectionProvider.notifier).state = NavSection.reports;
...
// ══════════════════════════════════════════════════════════════════════
// ✦ DASH HERO CARD (HTML MOCKUP)
// ══════════════════════════════════════════════════════════════════════
class _DashHeroCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final dailyFormatted = 'Rs ${dailyRevenue.toInt().toString().replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (m) => '${m[1]},')}';
    ...
    return RepaintBoundary(
      child: Container(
        ...
        child: Stack(
          children: [
            // Gold ambient radial glow (top-right)
            Positioned(
              right: -60,
              top: -60,
              child: Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [Color(0x33FFC65A), Colors.transparent],
                  ),
                ),
              ),
            ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  shape: BoxShape.circle,
                  gradient: RadialGradient(
                    colors: [Color(0x1F5478E8), Colors.transparent],
                  ),
                ),
              ),
            ),
                ...
                final leftInfo = Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildChip(
                          dotColor: const Color(0xFFE9A227),
                          text: '$inProgressCount orders in progress',
                        ),
                        if (overdueCount > 0)
                          _buildChip(
                            dotColor: const Color(0xFFEF5261),
                    ...
                    Container(
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFFFFC65A), Color(0xFFE9A227)],
                        ),
                        borderRadius: BorderRadius.circular(12),
                        boxShadow: const [
                          BoxShadow(
  ...
  Widget _buildChip({required Color dotColor, required String text}) {
    return Container(
